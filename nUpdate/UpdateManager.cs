...
namespace nUpdate
{
    ...
    public class UpdateManager : IDisposable
    {
        ...
        public bool SearchForUpdates()
        {
            ...
            foreach (var updateConfiguration in PackageConfigurations)
            {
                ...
                if (_packageOperations == null)
                    _packageOperations = new Dictionary<UpdateVersion, IEnumerable<IUpdateAction>>();
        ...
        private Dictionary<UpdateVersion, IEnumerable<IUpdateAction>> _packageOperations; // obsolete
